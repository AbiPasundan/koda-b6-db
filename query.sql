...
INSERT INTO discount (discount_rate, description, is_flash_sale)
  VALUES
    ...
    (1, 'Promo Februari', TRUE), -- 6
    (0, 'Imlek', TRUE), -- 7
    (10, 'Promo Februari', TRUE), -- 8
    (9, 'Gift', FALSE), -- 9
    (100, 'testing', FALSE); -- 10
...
VALUES
('Kapal Api Latte', 'Fresh milk coffee', 25000, 10, 1), -- 1
('Latte Art', 'Fresh milk coffee', 25000, 10, 1), -- 2
('Berry Good & Ice Cream', 'idangan penutup berbahan dasar stroberi segar, sering kali berupa es krim yang dicampur dengan buah beri utuh atau saus beri kental.', 45000, 17, 2), -- 3
('V60', 'Metode seduh kopi manual (manual brew) yang menghasilkan kopi bersih dan aromatik menggunakan dripper berbentuk V', 15000, 30, 5), -- 4
('Cold Brew Coffee', 'metode penyeduhan kopi dengan merendam bubuk kopi giling kasar dalam air dingin/suhu ruang selama 12–24 jam, menghasilkan konsentrat kopi rendah asam, manis alami, dan halus.', 20000, 23, 7), -- 5
('Aero press', 'No Description Yet', 21000, 3, 8), -- 6
('Vietnam Drip', 'Metode seduh kopi khas Vietnam menggunakan saringan logam kecil, menghasilkan kopi pekat ala espresso yang biasa disajikan di atas susu kental manis.', 24000, 9, 8), --7 
('Brownies & Ice Cream', 'No Description Yet', 28500, 5, 1), -- 8
('Brownies Choco Chips', 'No Description Yet', 23000, 3, 8), -- 9 
('Brownies Choco Almond', 'No Description Yet', 235000, 3, 8), -- 10
('Cheese Danish', 'kue pastry (kue kering berlapis) yang terkenal dengan tekstur renyah di luar, lembut di dalam, serta isian krim keju manis yang gurih.', 29500, 7, 3), -- 11
('Croissant Ham & Cheese', 'kombinasi sarapan atau camilan klasik yang terdiri dari roti croissant renyah yang diisi dengan ham gurih dan keju leleh, seringkali dipanggang hingga keju meleleh sempurna.', 30000, 3, 8), -- 12 
('Piccolo Latte', 'minuman kopi susu berbasis espresso berukuran mini, biasanya disajikan dalam gelas 85-114 ml.', 30000, 3, 8), --13
('Almond Gallete Pie', 'Kue pastri berbentuk bundar yang renyah dan berlapis-lapis (puff pastry) dengan isian krim almond manis yang lembut.', 13500, 1, 7), -- 14
('Cheese Danish', 'Kue pastry (kue kering berlapis) yang terkenal dengan tekstur renyah di luar, lembut di dalam, serta isian krim keju manis yang gurih', 23000, 5, 2), --15
('Croissant Ham & Cheese', 'Kombinasi sarapan atau camilan klasik yang terdiri dari roti croissant renyah yang diisi dengan ham gurih dan keju leleh, seringkali dipanggang hingga keju meleleh sempurna.', 24000, 11, 7) --16
RETURNING id;

INSERT INTO product_categories (product_id, category_id)
VALUES (1,1), (2,1), (3,2), (3,5), (4,1), (5,1), (6,1), (7,1), (8,3), (8,7), (9,3), (9,7), (10,2), (10,3), (10,7), (11,2), (11,3), (11,5), (12,7), (12,2), (12,3), (13,1), (14,3), (14,7), (15,3), (15,6), (16,3), (16,7);
...
INSERT INTO
  ...
  VALUES
  (1, 'test/images/kapal.heic'), 
  (1, 'test/images/api.png'),
  (2, 'test/images/beir.jpeg'),
  (3, 'test/images/img.jpg'),
  (4, 'test/images/v60.png'),
  (5, 'test/images/v60.png'),
  (6, 'test/images/coldbrew.heic'),
  (7, 'test/images/aeropress.png'),
  (8, 'test/images/brownisice.jpeg'),
  (9, 'test/images/brownischoko.webp'),
  (10, 'test/images/brownish.jpeg'),
  (11, 'test/images/danish.png'),
  (12, 'test/images/corsiant.png'),
  (13, 'test/images/picolo.png'),
  (14, 'test/images/almondpastry.jpg'),
  (15, 'test/images/pastry.jpeg'),
  (16, 'test/images/crosian.heic');


INSERT INTO
  reviews
  (review_id, user_id, product_id, messages, ratings )
  VALUES
  (DEFAULT, 1, 1, 'testing reviews', 5),
  (DEFAULT, 3, 2, 'bagus lumayan', 1),
  (DEFAULT, 5, 3, 'sangat buruk', 4),
  (DEFAULT, 2, 4, 'rekomended', 3),
  (DEFAULT, 6, 5, 'cheap and good', 2),
  (DEFAULT, 8, 6, 'hidden gem', 5),
  (DEFAULT, 7, 7, 'art of quality', 1),
  (DEFAULT, 4, 8, 'banyak tukang parkir', 3);
